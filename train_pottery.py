...
parser.add_argument('--model', default='dgcnn_pottery', help='Model name: dgcnn_pottery, dgcnn+skipdense')
...
parser.add_argument('--momentum', type=float, default=0.9, help='momentum parameter [default: 0.9]')
...
#        current_data, current_label, current_size = provider.loadDataFile(TRAIN_FILES[train_file_idxs[fn]])
