...
# def combine:
	...
	# global_feature_list = []
	# for i in inputs:
		# global_feature_list.append(get_model(??))
		
	# # global_feature_list 에는 각 파편 개수만큼의 tensor (global feature)가 있음.
	# placeholder 새로 정의 ( combine 결고 ㅏ모양)
	# placeholder = global_feature_list의 모든 tensor combine.
